...
class SelfConfidenceTest extends StatefulWidget {
  const SelfConfidenceTest({super.key});

  @override
  _SelfConfidenceTestState createState() => _SelfConfidenceTestState();
}

class _SelfConfidenceTestState extends State<SelfConfidenceTest> {
  ...
  final List<Map<String, dynamic>> surveyData = [
    {
      'questions': [
        {
          'question':
              'لدي القدرة على أداء المهارات الحركية الضرورية لإحراز التفوق خلال المنافسة الرياضية',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question':
              'لدي القدرة على اتخاذ قرارات حاسمة خلال المنافسة الرياضية',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة على الأداء في المنافسة تحت الضغوط العصبية',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة على تنفيذ خطط ناجحة في المنافسة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة علي التركيز بصورة جيدة لكي أحقق النجاح',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question':
              'لدي القدرة على التكيف مع المواقف المختلفة لكي أحقق الفوز في المنافسة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة على إنجاز أهدافي المرتبطة بالمنافسة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة على أن أكون ناجحا في المنافسة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة على أن يستمر نجاحي',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة على التفكير و الاستجابة بنجاح أثناء المنافسة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة على مواجهة التحدي أثناء المنافسة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة علي محاولة النجاح ولو كان المنافس أقوي مني',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي القدرة علي القيام بأداء ناجح بعد قيامي بأداء فاشل',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
