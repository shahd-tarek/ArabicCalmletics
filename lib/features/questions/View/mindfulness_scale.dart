...
import 'package:calmleticsarab/features/questions/View/finalscore.dart';

class MindfulnesScale extends StatefulWidget {
  const MindfulnesScale({super.key});

  @override
  _MindfulnesScaleState createState() => _MindfulnesScaleState();
}

class _MindfulnesScaleState extends State<MindfulnesScale> {
  ...
  final List<Map<String, dynamic>> surveyData = [
    {
      'questions': [
        {
          'question': 'واع بالأنفعالات المختلفة التي تظهر',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أحاول توجيه الأنتباه إلي الأنفعالات السارة و الغير سارة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أجد بعض من خبراتي ممتعة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'ألاحظ تفاصيل دقيقة من خبراتي',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أصبح واعيا بما يحدث داخلي',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'ألاحظ الانفعالات السارة و الغير سارة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أستكشف بفاعلية خبراتي في اللحظة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أشعر بوضوح بما يحدث داخل جسمي',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question':
              'أقوم بتغيير أوضاع الجسم و أعطي اهتماما للعملية البدنية للحركة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أمارس خبرة اللحظة الحاضرة كاملة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'ألاحظ الأفكار السارة والغير سارة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أشعر بالأنفعالات تأتي و تذهب',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question':
              'أشعر بأحاسيس متعددة في الجو المحيط (الحرارة , البرودة , ملامسة الرياح للوجه)',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أشعر بالأحاسيس الجسمية تأتي و تذهب',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'لدي لحظات شعرت فيها باليقظة و الوعي',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أشعر بارتباط لصيق باللحظة الحاضرة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'ألاحظ الأفكار تأتي و تذهب',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أشعر بالأتصال مع الجسم',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'علي وعي بما يدور في عقلي',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أستمتع برؤية أنماط لأفكاري',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
    ...
    },
    {
      'questions': [
        {
          'question': 'أشعر ببعض الأحاسيس الجسمية السارة و الغير سارة',
          'options': {
            'لا على الإطلاق': 1,
            'إلى حد ما': 2,
            'محايد/ غير متأكد': 3,
  ...
  Widget build(BuildContext context) {
    ...
    final double fontSizeOption = screenWidth * 0.045;
                    ...
                    child: ElevatedButton(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          optionText,
                          style: TextStyle(
                              fontSize: fontSizeOption, color: textcolor),
                        ),
                      ),
                    ),
                  );
