...
import 'package:calmleticsarab/features/calmRoutine/View/box_breathing.dart';
import 'package:calmleticsarab/constant.dart';

class MentalWarmUp extends StatefulWidget {
  final int pageIndex;
  ...
  @override
  State<MentalWarmUp> createState() => _MentalWarmUpState();
}

class _MentalWarmUpState extends State<MentalWarmUp> {
