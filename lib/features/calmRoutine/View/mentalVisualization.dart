...
import 'package:calmleticsarab/features/calmRoutine/View/audio_place.dart';

class MentalVisualization extends StatefulWidget {
  final int pageIndex;
  final int totalPages;

  const MentalVisualization({
    super.key,
  ...
  @override
  State<MentalVisualization> createState() => _MentalVisualizationState();
}

class _MentalVisualizationState extends State<MentalVisualization> {
