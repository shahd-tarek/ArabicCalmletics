...
import 'package:calmleticsarab/features/survey/View/end_survey.dart';
  ...
  Widget buildSurveyPage(Map<String, dynamic> page, int pageIndex) {
    return Column(
      ...
      children: [
        ...
        Container(height: 24, color: const Color.fromRGBO(237, 237, 237, 1)),
        Container(
          padding: const EdgeInsets.all(16.0),
          color: const Color.fromRGBO(255, 255, 255, 1),
...
final List<Map<String, dynamic>> surveyData = [
  {
    ...
    'questions': [
      ...
      },
      {
        'id': 2,
        'question': 'ما هو عمرك؟',
        'options': ['أقل من 18 سنة', '18-24', '25-34'],
      },
      {
        'id': 3,
        'question': 'ما هو وضعك الحالي؟',
        'options': ['أعمل', 'أدرس', 'لا أعمل حاليًا'],
      },
    ],
  },
  {
    ...
    'questions': [
      ...
      },
      {
        ...
        'options': ['نادرًا', 'أحيانًا', 'كثيرًا', 'دائمًا'],
      },
      {
        'id': 6,
